...
/*____________Итоговая_контрольная_работа_____________________________________________________________--*/

string[] word = {"my", "dream", "is", "life", "in", "California" };
...
int NumberOfThreeSumbolWords(string[] array)
{
...
int count = NumberOfThreeSumbolWords(array1);
